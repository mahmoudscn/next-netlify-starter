...
<Group description="Backgrounds">
  ...
  <Variable name="body.background" description="Background"
      ...
      type="background"
      default="$(color) none repeat scroll top left"  value="#eeeeee url(none) no-repeat scroll top center /* Credit: Michael Elkan (http://www.offset.com/photos/394244) */"/>
          ...
          <input class='search-action flat-button' expr:value='data:messages.search.escaped' type='submit'/>
                ...
                <div class='blog-name container'>
                  <b:section class='container' id='header' name='Header' showaddelement='false'>
                    <b:widget id='Header1' locked='true' title='Colors Dating App (Header)' type='Header' visible='true'>
                      <b:widget-settings>
                  ...
                  <nav role='navigation'>
                    <b:section class='clearboth' id='page_list_top' name='Page List (Top)' showaddelement='false'>
                      <b:widget cond='!data:view.isPost' id='PageList1' locked='true' title='' type='PageList' visible='false'>
                        <b:widget-settings>
                          <b:widget-setting name='pageListJson'><![CDATA[{'home': {'href': 'http://colorsdatingapp.blogspot.com/', 'title': 'Home', 'position': 0}}]]></b:widget-setting>
